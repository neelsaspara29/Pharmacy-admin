    ...
    return <>
        ...
        <ul className="navi">
            ...
            <li className="navi-footer pt-5 pb-4">
                <a className="btn btn-light-primary font-weight-bolder btn-sm" >More options</a>
                <a className="btn btn-clean font-weight-bold btn-sm d-none" data-toggle="tooltip"
