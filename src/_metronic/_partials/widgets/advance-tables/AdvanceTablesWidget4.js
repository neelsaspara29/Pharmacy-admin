    ...
    <div className={`card card-custom ${className}`}>
      ...
      <div className="card-header border-0 py-5">
        ...
        <div className="card-toolbar">
          <a className="btn btn-info font-weight-bolder font-size-sm mr-3">New Report</a>
          <a className="btn btn-danger font-weight-bolder font-size-sm">Create</a>
        </div>
      </div>
      {/* Body */}
            ...
            <table className="table table-head-custom table-head-bg table-borderless table-vertical-center">
              ...
              <tbody>
                <tr>
                  <td className="pl-0 py-8">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <a className="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Brad
                          Simmons</a>
                  ...
                  <td className="pr-0 text-right">
                    <a className="btn btn-light-success font-weight-bolder font-size-sm">View Offer</a>
                  </td>
                </tr>
                <tr>
                  <td className="pl-0 py-0">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <a className="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Jessie
                          Clarcson</a>
                ...
                <tr>
                  ...
                  <td className="pr-0 text-right">
                    <a className="btn btn-light-success font-weight-bolder font-size-sm"
                      style={{ width: "7rem" }}>
                      View Offer
                    </a>
                  </td>
